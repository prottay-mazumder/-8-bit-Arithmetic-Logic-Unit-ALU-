...
REM
REM Generated by Vivado on Thu May 28 13:37:46 +0600 2026
...
echo "xvlog --incr --relax -prj tb_alu_advanced_vlog.prj"
call xvlog  --incr --relax -prj tb_alu_advanced_vlog.prj -log xvlog.log
